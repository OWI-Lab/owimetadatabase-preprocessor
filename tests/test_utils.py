...
@pytest.mark.parametrize(
    ...
    [
        ...
        (np.nan, "test", (False, 'Types of nan and test are different: float and str.')),
        (None, None, (True, None)),
        (None, 1.0, (False, 'Types of None and 1.0 are different: NoneType and float.')),
        ({"key_1": 1.0, "key_2": "value_2"}, {"key_1": 1.0, "key_2": "value_2"}, (True, None)),
        (
        ...
        (
            ...
            (
                False,
                (
                    "Dictionary values are different for {'key_1': 1.0, 'key_2': 'value_2'} and {'key_1': 1.0, 'key_2': 'value_3'},"
                    " for keys: ['key_2']."
                )
            )
        ),
        ...
        ([1, 2, 3], [1, 2, 3, 4], (False, "Lists/tuples [1, 2, 3] and [1, 2, 3, 4] are of different length: 3 and 4.")),
        ([1, 2, 3], [1, 2, 4], (False, "Lists/tuples are different for [1, 2, 3] and [1, 2, 4], for indices: [2].")),
